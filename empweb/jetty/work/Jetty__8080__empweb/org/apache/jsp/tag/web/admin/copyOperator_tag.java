...
public final class copyOperator_tag
  ...
  public void doTag() throws JspException, java.io.IOException {
    ...
    _jspInit(config);
    if( getSourceId() != null ) 
      _jspx_page_context.setAttribute("sourceId", getSourceId());
    if( getDestId() != null ) 
      _jspx_page_context.setAttribute("destId", getDestId());
...
if ("".equals(result)) {
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("copy_operator_failed");
