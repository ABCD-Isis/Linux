...
$mxinv=$converter_path." ".$db_path.$base_ant."/data/".$base_ant." fst=@".$db_path.$base_ant."/data/fulltext.fst fullinv/m=".$db_path.$base_ant."/data/".$base_ant." actab=".$db_path."/isisac.tab now -all tell=1";
